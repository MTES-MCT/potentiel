...
describe(`Méthode exceedsRatiosChangementPuissance`, () => {
  ...
  describe(`Lorsque l'appel d'offre existe`, () => {
    describe(`Lorsque l'appel d'offre dispose de cahiers des charges modifiés disponible`, () => {
      describe(`Lorsque le cahier des charges actuel du projet ne figure pas dans la liste des cdc modifiés disponible de l'AO`, () => {
        describe(`Alors on se base sur le ratio défini dans l'appel d'offre`, () => {})
      })
    })
  })

  describe(`Lorsque l'appel d'offre ne dispose pas de cahier des charges modifiés disponible, alors on se base sur le ratio défini dans l'appel d'offre`, () => {
    describe(`Lorsque le ratio n'est pas défini par technologie `, () => {
    ...
    describe(`Lorsque le ratio est défini par technologie`, () => {
      ...
      describe(`Lorsque la technologie est connue, on se base sur son ratio`, () => {
        const appelOffre = {
          changementPuissance: {
