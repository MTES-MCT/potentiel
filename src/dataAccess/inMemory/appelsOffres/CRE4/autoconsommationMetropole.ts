...
const autoconsommationMetropole: AppelOffre = {
  ...
  periodes: [
    ...
    },
    {
      ...
      noteThreshold: [{ familleId: '', noteThreshold: 20.04 }],
    ...
    },
    {
      ...
      paragrapheAchevement: '6.3',
      noteThresholdBy: 'family',
      noteThreshold: [{ familleId: '', noteThreshold: 32.04 }],
      isNotifiedOnPotentiel: true,
    ...
    },
    {
      ...
      paragrapheAchevement: '6.3',
      noteThresholdBy: 'family',
      noteThreshold: [{ familleId: '', noteThreshold: 9.9 }],
      isNotifiedOnPotentiel: true,
      certificateTemplate: 'cre4.v1',
    },
    {
      ...
      paragrapheAchevement: '6.3',
      noteThresholdBy: 'family',
      noteThreshold: [{ familleId: '', noteThreshold: 44.9 }],
      isNotifiedOnPotentiel: true,
      certificateTemplate: 'cre4.v1',
    },
  ],
