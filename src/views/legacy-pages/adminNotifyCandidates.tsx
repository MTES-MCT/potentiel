import { AdminDashboard, Button, DownloadIcon, PageTemplate, ProjectList } from '@components'
        ...
        <div className="panel">
          <div className="panel__header">
            ...
            {request.user.role !== 'dgec-validateur' && (
              <p>
                Seules les personnes ayant délégation de signature sont habilitées à notifier un
                appel d'offres. <br />
