      ...
      <AdminDashboard role={request.user?.role} currentPage="regenerate-certificates">
        <div className="panel">
          ...
          <p>
            ...
            projets d‘une période. Cette fonction peut être utile lorsqu‘une erreur a pu être
            corrigée sur le modèle de l‘attestation ou dans les données relatives à un appel
            d‘offre.
          </p>
          ...
          >
            ...
            <div className="form__group">
              <label htmlFor="forceCertificateGeneration">
                Message justificatif du changement (facultatif, sera inclus dans le mail aux
                porteurs de projet)
              </label>
