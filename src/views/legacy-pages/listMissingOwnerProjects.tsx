...
import { MissingOwnerProjectList } from '@components'
    ...
    <div className="panel">
      <div className="panel__header">
        ...
        <div className="notification">
          <span>
            Pour ajouter un projet à votre suivi de projets (onglet "Mes projets"), sélectionnez-le,
            qu’il vous soit pré-affecté ou non.
            <br />
