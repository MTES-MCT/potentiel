...
const MenuItem = ({ children, href, isCurrent }: MenuItemProps) => (
  <li className="py-2 lg:px-4 border-0 border-b lg:border-b-0 border-solid border-slate-200 lg:p-4 hover:bg-grey-1000-hover ">
    <a
      className={`no-underline pl-4 lg:pl-0 lg:pb-3${
        isCurrent &&
        ' font-medium border-0 border-l-4 border-solid border-blue-france-sun-base lg:border-l-0 lg:border-b-4'
      }`}
      href={href}
      {...(isCurrent
