...
export const Button: FC<ButtonProps> = ({ children, className = '', ...props }) => (
  <button
    className={`inline-flex items-center cursor-pointer px-6 py-2 border border-solid text-base text-decoration-none shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2
