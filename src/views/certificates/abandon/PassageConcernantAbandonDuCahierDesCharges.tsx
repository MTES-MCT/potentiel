  ...
  return (
    <>
      ...
      <Text style={{ fontSize: 10, textAlign: 'justify', marginTop: 10 }}>
        ...
        que cette recandidature respectera les conditions suivantes : - Le dossier doit être complet
        et respecter les conditions d’éligibilité du cahier des charges de la période concernée par
        la recandidature ; - Le projet doit avoir le même lieu d’implantation que le projet
        abandonné ; - Le projet doit être d’une puissance équivalente que le projet abandonné, à
        plus ou moins 20% ; - Le tarif proposé ne doit pas être supérieur au tarif du dernier
        lauréat retenu pour la période dont le projet était initialement lauréat (et le cas échéant
        de la famille concernée) indexé jusqu'à septembre 2023. Une fois cette recandidature
        respectant les conditions précédentes indiquée sur Potentiel, vos garanties financières
        pourront alors être levées.
      </Text>
    </>
  );
};
