...
export const ChampsAideALaSaisieIdentifiant = ({
  ...
  <>
    <div>
      <Label htmlFor="format" optionnel>
        Format de l'identifiant du dossier de raccordement
      </Label>
    ...
    <div>
      <Label htmlFor="légende" optionnel>
        Aide à la saisie de l'identifiant du dossier de raccordement
      </Label>
      <LabelDescription>
