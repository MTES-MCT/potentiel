...
describe('getProjectEvents for DemandeRecoursSignaled events', () => {
  ...
  describe('when there are demande recours signaled event', () => {
    describe('when user is not ademe', () => {
      for (const role of USER_ROLES.filter((role) => role !== 'ademe')) {
        describe(`when the user is ${role}`, () => {
          ...
          it('should return demande recours signaled event', async () => {
    ...
    describe('when the user is ademe', () => {
      it('should not return the demande recours signaled event', async () => {
