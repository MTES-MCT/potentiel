...
export const donnéesProjetParCatégorie: Record<string, Colonne[]> = {
  ...
  'modifications avant import': [
    { champ: json(`detail->>'Type de modification 1'`), intitulé: 'Type de modification 1' },
    { champ: json(`detail->> 'Date de modification 1'`), intitulé: 'Date de modification 1' },
    { champ: json(`detail->> 'Colonne concernée 1'`), intitulé: 'Colonne concernée 1' },
    { champ: json(`detail->> 'Ancienne valeur 1'`), intitulé: 'Ancienne valeur 1' },
    { champ: json(`detail->>'Type de modification 2'`), intitulé: 'Type de modification 2' },
    { champ: json(`detail->> 'Date de modification 2'`), intitulé: 'Date de modification 2' },
    { champ: json(`detail->> 'Colonne concernée 2'`), intitulé: 'Colonne concernée 2' },
    { champ: json(`detail->> 'Ancienne valeur 2'`), intitulé: 'Ancienne valeur 2' },
    { champ: json(`detail->>'Type de modification 3'`), intitulé: 'Type de modification 3' },
    { champ: json(`detail->> 'Date de modification 3'`), intitulé: 'Date de modification 3' },
    { champ: json(`detail->> 'Colonne concernée 3'`), intitulé: 'Colonne concernée 3' },
    { champ: json(`detail->> 'Ancienne valeur 3'`), intitulé: 'Ancienne valeur 3' },
    { champ: json(`detail->>'Type de modification 4'`), intitulé: 'Type de modification 4' },
    { champ: json(`detail->> 'Date de modification 4'`), intitulé: 'Date de modification 4' },
    { champ: json(`detail->> 'Colonne concernée 4'`), intitulé: 'Colonne concernée 4' },
    { champ: json(`detail->> 'Ancienne valeur 4'`), intitulé: 'Ancienne valeur 4' },
    { champ: json(`detail->>'Type de modification 5'`), intitulé: 'Type de modification 5' },
    { champ: json(`detail->> 'Date de modification 5'`), intitulé: 'Date de modification 5' },
    { champ: json(`detail->> 'Colonne concernée 5'`), intitulé: 'Colonne concernée 5' },
    { champ: json(`detail->> 'Ancienne valeur 5'`), intitulé: 'Ancienne valeur 5' },
  ],
