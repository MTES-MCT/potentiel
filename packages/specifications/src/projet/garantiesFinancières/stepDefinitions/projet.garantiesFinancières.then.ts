...
Alors(
  `les garanties financières (complètes )devraient être (consultables )(mises à jour )dans le projet {string}`,
...
Alors(
  `le fichier de l'attestation de garanties financières devrait être téléchargeable pour le projet {string}`,
