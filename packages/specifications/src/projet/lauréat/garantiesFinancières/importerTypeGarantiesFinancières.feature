...
Fonctionnalité: Importer le type (et la date d'échéance selon le cas) des garanties financières d'un projet
    ...
    @NotImplemented
    Scénario: Impossible d'importer le type (et la date d'échéance selon le cas) des garanties financières si le projet dispose déjà de garanties financières échues
