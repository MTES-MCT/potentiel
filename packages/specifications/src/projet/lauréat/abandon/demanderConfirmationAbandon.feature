...
Fonctionnalité: Demander une confirmation d'abandon d'un projet lauréat
    ...
    Scénario: La DGEC demande de confirmer la demande d'abandon d'un projet lauréat
        ...
        Quand l'utilisateur dgec demande une confirmation de la demande d'abandon pour le projet lauréat
        ...
        Et un email a été envoyé au porteur avec :
            | sujet      | Potentiel - Du boulodrome de Marseille - Demande d'abandon en attente de confirmation |
    ...
    Scénario: Impossible de demander de confirmer la demande d'abandon d'un projet lauréat si la demande a déjà été rejetée
        ...
        Quand l'utilisateur dgec demande une confirmation de la demande d'abandon pour le projet lauréat
        Alors l'utilisateur dgec devrait être informé que "La demande d'abandon a déjà été rejetée"
    ...
    Scénario: Impossible de demander de nouveau de confirmer la demande d'abandon d'un projet lauréat
        ...
        Quand l'utilisateur dgec demande une confirmation de la demande d'abandon pour le projet lauréat
        Alors l'utilisateur dgec devrait être informé que "La demande d'abandon est déjà en attente de confirmation"
    ...
    Scénario: Impossible de demander de confirmer une demande d'abandon déjà confirmée
        ...
        Quand l'utilisateur dgec demande une confirmation de la demande d'abandon pour le projet lauréat
        Alors l'utilisateur dgec devrait être informé que "La demande d'abandon a déjà été confirmée"
