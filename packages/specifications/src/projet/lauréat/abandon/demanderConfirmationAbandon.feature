...
@select
    ...
    @select
    Plan du Scénario: Impossible de demander une confirmation d'abandon d'un projet lauréat en tant qu'utilisateur n'ayant pas le rôle de validateur
      Etant donné une demande d'abandon en cours pour le projet lauréat "Du boulodrome de Marseille"
      Quand "<Role non autorisé>" demande une confirmation d'abandon pour le projet lauréat "Du boulodrome de Marseille"
