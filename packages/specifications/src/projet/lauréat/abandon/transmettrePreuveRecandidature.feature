...
@select
    Scénario: Impossible de transmettre comme preuve de recandidature un projet dont la date de notification est ultérieure au 31/03/2025
      ...
      Et un abandon accordé avec recandidature pour le projet lauréat "Du boulodrome de Marseille"
      Quand "le porteur" transmet le projet lauréat "Boulodrome Sainte Livrade" comme preuve de recandidature suite à l'abandon du projet "Du boulodrome de Marseille" avec :
      | La date de notification du projet | 2025-04-02 |
    ...
    @select
    Plan du Scénario: Impossible de transmettre une preuve de recandidature en tant qu'utilisateur n'ayant pas le rôle de porteur
      Etant donné le projet lauréat "Boulodrome Sainte Livrade"
      Et un abandon accordé avec recandidature pour le projet lauréat "Du boulodrome de Marseille"
      Quand "<Role non autorisé>" transmet le projet lauréat "Boulodrome Sainte Livrade" comme preuve de recandidature suite à l'abandon du projet "Du boulodrome de Marseille" avec :
