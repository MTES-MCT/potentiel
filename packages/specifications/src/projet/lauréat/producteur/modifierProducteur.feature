# language: fr
@producteur
Fonctionnalité: Modifier le producteur d'un projet lauréat en tant qu'admin
    ...
    Scénario: Modifier le siret uniquement
        Quand la DGEC modifie le producteur avec :
    ...
    Scénario: Impossible de modifier le producteur d'un projet éliminé
        ...
        Quand la DGEC modifie le producteur du projet éliminé
