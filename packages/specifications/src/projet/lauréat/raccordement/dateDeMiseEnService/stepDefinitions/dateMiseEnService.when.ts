...
Quand(
  ...
  async function (this: PotentielWorld) {
    ...
    const { dateMiseEnService, référenceDossier } =
      this.lauréatWorld.raccordementWorld.dateMiseEnService.modifierFixture.créer({
        identifiantProjet: identifiantProjet.formatter(),
        référenceDossier: this.lauréatWorld.raccordementWorld.référenceDossier,
      });
  ...
  async function (this: PotentielWorld, datatable: DataTable) {
    ...
    const { dateMiseEnService, référenceDossier } =
      this.lauréatWorld.raccordementWorld.dateMiseEnService.modifierFixture.créer({
        identifiantProjet: identifiantProjet.formatter(),
        référenceDossier: this.lauréatWorld.raccordementWorld.référenceDossier,
        ...this.lauréatWorld.raccordementWorld.dateMiseEnService.modifierFixture.mapExempleToFixtureValues(
          datatable.rowsHash(),
        ),
      });
