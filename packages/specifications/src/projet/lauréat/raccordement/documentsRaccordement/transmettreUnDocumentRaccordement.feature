...
@select
Fonctionnalité: Transmettre un document de raccordement
  ...
  Scénario: Un porteur de projet transmet un document de raccordement pour le dossier de raccordement d'un projet achevé
    Etant donné une demande complète de raccordement pour le projet lauréat
  ...
  Scénario: Impossible de transmettre un document de raccordement pour un projet sans dossier de raccordement
    Quand le porteur transmet un document de raccordement transmis pour le projet lauréat avec :
      | La référence du dossier de raccordement | OUE-RP-2022-000033 |
    Alors le porteur devrait être informé que "Le dossier n'est pas référencé dans le raccordement de ce projet"

  Scénario: Impossible de transmettre un document de raccordement pour un dossier n'étant pas référencé dans le raccordement du projet
    Etant donné une demande complète de raccordement pour le projet lauréat
    Quand le porteur transmet un document de raccordement transmis pour le projet lauréat avec :
      | La référence du dossier de raccordement | OUE-RP-2022-000034 |
    Alors le porteur devrait être informé que "Le dossier n'est pas référencé dans le raccordement de ce projet"

  Scénario: Impossible de transmettre un document de raccordement avec une date de signature dans le futur
    Etant donné une demande complète de raccordement pour le projet lauréat
    Quand le porteur transmet un document de raccordement transmis pour le projet lauréat avec :
      | La date de signature | 2999-12-31 |
    Alors le porteur devrait être informé que "La date ne peut pas être une date future"

  Scénario: Impossible de transmettre un document de raccordement pour un projet abandonné
    Etant donné une demande complète de raccordement pour le projet lauréat
  ...
  Scénario: Impossible de transmettre un document de raccordement pour un projet avec une demande d'abandon en cours
    Etant donné une demande complète de raccordement pour le projet lauréat
  ...
  Scénario: Impossible de transmettre une convention de type "proposition technique et financière" si une convention de type "convention directe de raccordement" a déjà été transmise
    Etant donné une demande complète de raccordement pour le projet lauréat
    Et un document de raccordement transmis pour le projet lauréat avec :
