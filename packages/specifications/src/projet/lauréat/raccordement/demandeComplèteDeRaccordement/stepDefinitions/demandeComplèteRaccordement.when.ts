  ...
  async function (this: PotentielWorld, rôleUtilisateur: RôleUtilisateur, datatable: DataTable) {
    ...
    try {
      await modifierDemandeComplèteRaccordement.call(
        ...
        référenceDossier,
        getRôle.call(this, rôleUtilisateur),
        this.lauréatWorld.raccordementWorld.demandeComplèteDeRaccordement.mapExempleToFixtureValues(
          datatable.rowsHash(),
        ),
      );
    } catch (e) {
  ...
  async function (this: PotentielWorld, rôleUtilisateur: RôleUtilisateur, datatable: DataTable) {
    ...
    try {
      await modifierRéférenceDossierRaccordement.call(
        ...
        référenceDossier,
        getRôle.call(this, rôleUtilisateur),
        this.lauréatWorld.raccordementWorld.modifierRéférenceDossierRaccordementFixture.mapExempleToFixtureValues(
          datatable.rowsHash(),
        ),
      );
    } catch (e) {
...
export async function transmettreDemandeComplèteRaccordement(
  ...
  const { accuséRéception, dateQualification, référenceDossier } =
    this.lauréatWorld.raccordementWorld.demandeComplèteDeRaccordement.transmettreFixture.créer({
...
async function modifierDemandeComplèteRaccordement(
  ...
  const { accuséRéception, dateQualification, référenceDossier, estUnNouveauDocument } =
    this.lauréatWorld.raccordementWorld.demandeComplèteDeRaccordement.modifierFixture.créer({
      identifiantProjet,
...
async function modifierRéférenceDossierRaccordement(
  ...
  const { référenceDossier, nouvelleRéférenceDossier } =
    this.lauréatWorld.raccordementWorld.modifierRéférenceDossierRaccordementFixture.créer({
      identifiantProjet,
      référenceDossier: référence,
      ...data,
    });
