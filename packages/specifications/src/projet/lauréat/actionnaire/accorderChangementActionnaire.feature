...
Fonctionnalité: Accorder le changement d'actionnaire d'un projet lauréat
    ...
    Scénario: la DREAL accorde le changement d'actionnaire d'un projet lauréat
        Etant donné une demande de changement d'actionnaire en cours pour le projet lauréat
        Quand la DREAL accorde le changement d'actionnaire pour le projet lauréat
        ...
        Et un email a été envoyé au porteur avec :
            | sujet      | Potentiel - Du boulodrome de Marseille - Demande de changement d'actionnaire accordée |
