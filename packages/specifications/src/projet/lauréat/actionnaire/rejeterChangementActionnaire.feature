...
Fonctionnalité: Rejeter la demande de changement d'actionnaire d'un projet lauréat
    ...
    Scénario: la DREAL rejette le changement d'actionnaire d'un projet lauréat
        Etant donné une demande de changement d'actionnaire en cours pour le projet lauréat
        Quand la DREAL rejette le changement d'actionnaire pour le projet lauréat
        ...
        Et un email a été envoyé au porteur avec :
            | sujet      | Potentiel - Du boulodrome de Marseille - Demande de changement d'actionnaire rejetée |
