...
Fonctionnalité: Accorder le changement de puissance d'un projet lauréat
    ...
    Scénario: la DREAL accorde une demande de changement de puissance à la baisse d'un projet lauréat
        Etant donné une demande de changement de puissance pour le projet lauréat avec :
            | ratio puissance | 0.75 |
        Quand la DREAL accorde le changement de puissance pour le projet lauréat
    ...
    Scénario: la DREAL accorde une demande de changement de puissance à la hausse d'un projet lauréat
        Etant donné une demande de changement de puissance pour le projet lauréat avec :
    ...
    Scénario: la DREAL associée accorde un changement de puissance à la baisse pour décision de l'État
        Etant donné une demande de changement de puissance pour le projet lauréat avec :
            | ratio puissance | 0.75 |
        Quand la DREAL accorde le changement de puissance pour le projet lauréat avec :
    ...
    Scénario: Impossible d'accorder le changement de puissance à la hausse pour décision de l'État
        Etant donné une demande de changement de puissance pour le projet lauréat avec :
            | ratio puissance | 1.45 |
        Quand la DREAL accorde le changement de puissance pour le projet lauréat avec :
            | décision de l'État | oui |
