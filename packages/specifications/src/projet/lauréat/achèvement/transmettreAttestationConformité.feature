# language: fr
@achèvement
Fonctionnalité: Transmettre une attestation de conformité avec un rapport associé
  ...
  Scénario: le porteur transmet une attestation de conformité avec le rapport associé pour le projet lauréat
    ...
    Et un email a été envoyé au porteur avec :
      | sujet      | Potentiel - Du boulodrome de Marseille - Mise à jour de la date d'achèvement |
      | nom_projet | Du boulodrome de Marseille                                                   |
      | url        | https://potentiel.beta.gouv.fr/laureats/.*                                   |
