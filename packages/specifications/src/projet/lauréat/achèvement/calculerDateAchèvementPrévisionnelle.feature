...
Fonctionnalité: Calculer la date d'achèvement prévisionnelle

    Plan du scénario: Calculer la date d'achèvement prévisionnelle lorsqu'un projet lauréat est notifié
        ...
        Alors la date d'achèvement prévisionnelle du projet devrait être "<date prévisionnelle attendue>"
    ...
    Plan du scénario: Calculer la date d'achèvement prévisionnelle lorsqu'un lauréat ayant un délai de réalisation par technologie est notifié
        Etant donné la candidature lauréate "Du boulodrome de Marseille" avec :
            | appel d'offre | <appel d'offre>         |
