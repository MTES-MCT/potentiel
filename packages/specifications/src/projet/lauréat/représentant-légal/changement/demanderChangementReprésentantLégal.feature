...
Fonctionnalité: Demander le changement de représentant légal d'un projet lauréat
    ...
    Scénario: Un porteur demande un changement de représentant légal d'un projet lauréat
        Quand le porteur demande un changement de représentant légal le "2024-10-24"
        Alors une demande de changement de représentant légal du projet lauréat devrait être consultable
        Et un email a été envoyé à la dreal avec :
            | sujet      | Potentiel - Du boulodrome de Marseille - Changement de représentant légal demandé |
    ...
    Scénario: Impossible de demander un changement de représentant légal d'un projet lauréat si le changement est déjà en cours
        Etant donné une demande de changement de représentant légal en cours
        Quand le porteur demande un changement de représentant légal
        Alors le porteur devrait être informé que "Une demande de changement de représentant légal est déjà en cours"

    Scénario: Impossible de demander un changement de représentant légal d'un projet lauréat s'il a les même valeur que l'actuel
        Quand le porteur demande un changement de représentant légal avec les mêmes valeurs
        Alors le porteur devrait être informé que "Le représentant légal est identique à celui déjà associé au projet"

    Scénario: Impossible de demander un changement de représentant légal d'un projet lauréat s'il a le même nom que l'actuel
        Quand le porteur demande un changement de représentant légal avec le même nom
        Alors le porteur devrait être informé que "Le représentant légal a le même nom que celui associé au projet"

    Scénario: Impossible de demander un changement de représentant légal d'un projet lauréat si son type est inconnu
        Quand le porteur demande un changement de représentant légal avec un type inconnu
        Alors le porteur devrait être informé que "Le représentant légal ne peut pas avoir de type inconnu"

    Scénario: Impossible de demander un changement de représentant légal d'un projet lauréat abandonné
    ...
    Scénario: Impossible de demander un changement de représentant légal avec une demande d'abandon en cours
    ...
    Scénario: Impossible de demander un changement de représentant légal si le projet est achevé
    ...
    Scénario: Relance automatique pour l'instruction de la demande de changement de représentant légal d'un projet lauréat disposant d'un accord automatique
        ...
        Quand le système relance automatiquement la dreal pour faire l'accord de la demande de changement de représentant légal
        Alors un email a été envoyé à la dreal avec :
            | sujet                        | Potentiel - Du boulodrome de Verdun - Rappel d'instruction de la demande de modification du représentant légal |
    ...
    Scénario: Relance automatique pour l'instruction de la demande de changement de représentant légal d'un projet lauréat disposant d'un rejet automatique
        ...
        Et une demande de changement de représentant légal en cours
        Quand le système relance automatiquement la dreal pour faire le rejet de la demande de changement de représentant légal
        Alors un email a été envoyé à la dreal avec :
            | sujet                        | Potentiel - Du boulodrome de Besançon - Rappel d'instruction de la demande de modification du représentant légal |
