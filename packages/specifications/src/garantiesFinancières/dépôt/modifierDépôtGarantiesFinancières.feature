...
Fonctionnalité: Modifier le dépôt de garanties financières en attente de validation dans Potentiel
    ...
    Scénario: Erreur si date de constitution dans le futur
        Etant donné un dépôt de garanties financières pour le projet "Centrale éolienne 20" 
        Quand un utilisateur avec le rôle porteur-projet modifie un dépôt de garanties financières pour le projet "Centrale éolienne 20" avec une date de constitution dans le futur
    ...
    Scénario: Erreur si date de d'échéance manquante
        Etant donné un dépôt de garanties financières pour le projet "Centrale éolienne 20"
        Quand un utilisateur avec le rôle porteur-projet modifie un dépôt de garanties financières pour le projet "Centrale éolienne 20" avec la date d'échéance manquante
    ...
    Plan du Scénario: Erreur si date de d'échéance non compatible avec le type
        Etant donné un dépôt de garanties financières pour le projet "Centrale éolienne 20"
        Quand un utilisateur avec le rôle porteur-projet modifie un dépôt de garanties financières pour le projet "Centrale éolienne 20" avec un type et une date d'échéance non compatibles, avec : 
            | type                 | <type>                 |
