...
Fonctionnalité: Supprimer le raccordement d'un projet
    ...
    Scénario: l'utilisateur dgec supprime la mise en service du dossier de raccordement
        Etant donné une demande complète de raccordement pour le projet lauréat
        Et une proposition technique et financière pour le projet lauréat
        Et une date de mise en service pour le dossier de raccordement du projet lauréat
        Quand l'utilisateur dgec supprime la mise en service du dossier de raccordement
    ...
    Scénario: l'utilisateur dgec supprime la mise en service d'un dossier de raccordement alors que le projet dispose de plusieurs dossiers en service
        ...
        Quand l'utilisateur dgec supprime la mise en service du dossier de raccordement avec :
            | La référence du dossier de raccordement | OUE-RP-2022-000031 |
