...
Fonctionnalité: Modifier la référence d'une demande complète de raccordement
    ...
    Plan du Scénario: Modifier la référence d'une demande complète de raccordement
        ...
        Quand l'utilisateur avec le rôle "porteur-projet" modifie la demande complète de raccordement pour le projet lauréat ayant pour référence "<Référence actuelle>" avec la référence "OUE-RP-2022-000034"
    ...
    Plan du Scénario: Modifier en tant qu'administrateur la référence d'une demande complète de raccordement pour un dossier ayant déjà une date de mise en service
        Etant donné une demande complète de raccordement pour le projet lauréat transmise auprès du gestionnaire de réseau avec :
            ...
            | Le format de l'accusé de réception      | application/pdf                                                                                         |
            | Le contenu de l'accusé de réception     | Accusé de réception ayant pour référence <Référence actuelle> et la date de qualification au 2022-10-28 |
        Et une date de mise en service "2022-10-29" pour le dossier ayant comme référence "<Référence actuelle>" du raccordement pour le projet lauréat
        Quand l'utilisateur avec le rôle "admin" modifie la demande complète de raccordement pour le projet lauréat ayant pour référence "<Référence actuelle>" avec la référence "OUE-RP-2022-000034"
        Alors le dossier est consultable dans la liste des dossiers de raccordement du projet lauréat
        Et la demande complète de raccordement devrait être consultable dans le dossier de raccordement du projet lauréat
    ...
    Plan du Scénario: Modifier un dossier de raccordement suite à la modification de la référence
        Etant donné une demande complète de raccordement pour le projet lauréat transmise auprès du gestionnaire de réseau avec :
            ...
            | Le contenu de l'accusé de réception     | Accusé de réception ayant pour référence <Référence actuelle> et la date de qualification au 2022-10-28 |
        Quand l'utilisateur avec le rôle "porteur-projet" modifie la demande complète de raccordement pour le projet lauréat ayant pour référence "<Référence actuelle>" avec la référence "OUE-RP-2022-000034"
        Et l'utilisateur avec le rôle "porteur-projet" modifie la demande complète de raccordement pour le projet lauréat ayant pour référence "OUE-RP-2022-000034" auprès du gestionnaire de réseau avec :
    ...
    Plan du Scénario: Modifier la référence d'une demande complète de raccordement ayant une PTF
        Etant donné une demande complète de raccordement pour le projet lauréat transmise auprès du gestionnaire de réseau avec :
            ...
            | Le format de l'accusé de réception      | application/pdf                                                                                         |
            | Le contenu de l'accusé de réception     | Accusé de réception ayant pour référence <Référence actuelle> et la date de qualification au 2022-10-28 |
        Et une proposition technique et financière pour le dossier ayant comme référence "<Référence actuelle>" du raccordement pour le projet lauréat avec :
    ...
    Scénario: Impossible de modifier une demande complète de raccordement avec une référence ne correspondant pas au format défini par le gestionnaire de réseau
        ...
        Quand l'utilisateur avec le rôle "porteur-projet" modifie la demande complète de raccordement pour le projet lauréat ayant pour référence "ABC" avec la référence "UneRéférenceAvecUnFormatInvalide"
    ...
    Scénario: Impossible de modifier la référence pour un projet sans dossier de raccordement
        Quand l'utilisateur avec le rôle "porteur-projet" modifie la demande complète de raccordement pour le projet lauréat ayant pour référence "OUE-RP-2022-000033" avec la référence "OUE-RP-2022-000034"
    ...
    Scénario: Impossible de modifier la référence pour un dossier n'étant pas référencé dans le raccordement du projet
        ...
        Quand l'utilisateur avec le rôle "porteur-projet" modifie la demande complète de raccordement pour le projet lauréat ayant pour référence "OUE-RP-2022-000034" avec la référence "OUE-RP-2022-000035"
        Alors le porteur devrait être informé que "Le dossier n'est pas référencé dans le raccordement de ce projet"
    ...
    Scénario: Impossible pour un porteur de modifier la référence pour un dossier de raccordement ayant déjà une date de mise en service
        Etant donné une demande complète de raccordement pour le projet lauréat transmise auprès du gestionnaire de réseau avec :
            ...
            | Le format de l'accusé de réception      | application/pdf                                                                                       |
            | Le contenu de l'accusé de réception     | Accusé de réception ayant pour référence OUE-RP-2022-000033 et la date de qualification au 2022-10-28 |
        Et une date de mise en service "2022-10-29" pour le dossier ayant comme référence "OUE-RP-2022-000033" du raccordement pour le projet lauréat
        Quand l'utilisateur avec le rôle "porteur-projet" modifie la demande complète de raccordement pour le projet lauréat ayant pour référence "OUE-RP-2022-000033" avec la référence "OUE-RP-2022-000034"
    ...
    Scénario: Impossible pour une dreal de modifier la référence pour un dossier de raccordement ayant déjà une date de mise en service
        Etant donné une demande complète de raccordement pour le projet lauréat transmise auprès du gestionnaire de réseau avec :
            ...
            | Le contenu de l'accusé de réception     | Accusé de réception ayant pour référence OUE-RP-2022-000033 et la date de qualification au 2022-10-28 |
        Et une date de mise en service "2022-10-29" pour le dossier ayant comme référence "OUE-RP-2022-000033" du raccordement pour le projet lauréat
        Quand l'utilisateur avec le rôle "dreal" modifie la demande complète de raccordement pour le projet lauréat ayant pour référence "OUE-RP-2022-000033" avec la référence "OUE-RP-2022-000034"
