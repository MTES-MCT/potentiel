...
Fonctionnalité: Transmettre une proposition technique et financière
    ...
    Scénario: Un porteur de projet transmet une proposition technique et financière pour une demande complète de raccordement
        ...
        Quand le porteur de projet transmet une proposition technique et financière pour la demande complète de raccordement avec la date de signature au "28/04/2021"
        Alors une proposition technique et financière devrait être consultable dans la demande complète de raccordement avec une date de signature au au "28/04/2021"
