...
Fonctionnalité: Supprimer un dossier du raccordement d'un projet
    ...
    Scénario: la dgec supprime un dossier du raccordement ayant une date de mise en service
    ...
    Scénario: Supprimer le dossier (avec la date de mise en service la plus tardive) doit recalculer la mise en service du raccordement avec d'autres dossiers en service
        ...
        Quand la dgec supprime le dossier de raccordement pour le projet lauréat avec :
            | La référence du dossier de raccordement | OUE-RP-2022-000032 |
