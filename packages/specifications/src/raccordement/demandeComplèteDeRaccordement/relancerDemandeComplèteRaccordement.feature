...
Fonctionnalité: Relance pour demande complète de raccordement attendue
    ...
    Scénario: Relancer les porteurs pour demander l'ajout dans Potentiel de la demande complète de raccordement du projet
        Etant donné une tâche planifiée pour le projet lauréat avec :
            | type             | première relance demande complète raccordement à deux mois |
            | date d'exécution | 2025-01-11                                                 |
        Quand on exécute la tâche planifiée "première relance demande complète raccordement à deux mois" pour le projet lauréat à la date du "2025-11-01"
        ...
        Et une tâche "relance demande complète raccordement à un mois" est planifiée à la date du "2025-12-01" pour le projet lauréat
