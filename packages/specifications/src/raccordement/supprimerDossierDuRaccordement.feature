...
Fonctionnalité: Supprimer un dossier du raccordement d'un projet
    ...
    Scénario: Un porteur supprime un dossier du raccordement d'un projet
        Quand le porteur supprime le dossier ayant pour référence "OUE-RP-2022-000033" du raccordement pour le projet lauréat "Du boulodrome de Marseille"
    ...
    Scénario: Impossible de supprimer un dossier non référencé dans le raccordement du projet
        Quand le porteur supprime le dossier ayant pour référence "OUE-RP-2022-000034" du raccordement pour le projet lauréat "Du boulodrome de Marseille"
