...
Fonctionnalité: Transmettre une date de mise en service pour une demande complète de raccordement
    ...
    Scénario: Le gestionnaire de réseau transmet une date de mise en service pour un dossier de raccordement
        ...
        Quand le gestionnaire de réseau transmet la date de mise en service "2023-03-27" pour le dossier de raccordement du le projet lauréat ayant pour référence "OUE-RP-2022-000033"
        Alors la date de mise en service "2023-03-27" devrait être consultable dans le dossier de raccordement du le projet lauréat ayant pour référence "OUE-RP-2022-000033"
    ...
    Scénario: Impossible de transmettre une date de mise en service pour un dossier n'étant pas référencé dans le raccordement du projet
        Etant donné une demande complète de raccordement pour le projet lauréat transmise auprès du gestionnaire de réseau avec :
            ...
            | Le format de l'accusé de réception      | application/pdf                                                                                       |
            | Le contenu de l'accusé de réception     | Accusé de réception ayant pour référence OUE-RP-2022-000033 et la date de qualification au 2022-10-28 |
        Quand le gestionnaire de réseau transmet la date de mise en service "2023-03-27" pour le dossier de raccordement du le projet lauréat ayant pour référence "OUE-RP-2022-000034"
        Alors le gestionnaire de réseau devrait être informé que "Le dossier n'est pas référencé dans le raccordement de ce projet"
    ...
    Scénario: Impossible de transmettre une date de mise en service dans le futur
        Etant donné une demande complète de raccordement pour le projet lauréat transmise auprès du gestionnaire de réseau avec :
            ...
            | Le format de l'accusé de réception      | application/pdf                                                                                       |
            | Le contenu de l'accusé de réception     | Accusé de réception ayant pour référence OUE-RP-2022-000033 et la date de qualification au 2022-10-28 |
        Quand le gestionnaire de réseau transmet la date de mise en service "2999-03-27" pour le dossier de raccordement du le projet lauréat ayant pour référence "OUE-RP-2022-000033"
    ...
    Scénario: Impossible de transmettre une date de mise en service antérieure à la date de notification du projet
        ...
        Etant donné une demande complète de raccordement pour le projet lauréat transmise auprès du gestionnaire de réseau avec :
            ...
            | Le format de l'accusé de réception      | application/pdf                                                                                       |
            | Le contenu de l'accusé de réception     | Accusé de réception ayant pour référence OUE-RP-2022-000033 et la date de qualification au 2022-10-28 |
        Quand le gestionnaire de réseau transmet la date de mise en service "2021-12-31" pour le dossier de raccordement du le projet lauréat ayant pour référence "OUE-RP-2022-000033"
    ...
    Scénario: Impossible de transmettre une date de mise en service plus d'une fois
        Etant donné une demande complète de raccordement pour le projet lauréat transmise auprès du gestionnaire de réseau avec :
            ...
            | Le contenu de l'accusé de réception     | Accusé de réception ayant pour référence OUE-RP-2022-000033 et la date de qualification au 2022-10-28 |
        Quand le gestionnaire de réseau transmet la date de mise en service "2023-03-27" pour le dossier de raccordement du le projet lauréat ayant pour référence "OUE-RP-2022-000033"
        Et le gestionnaire de réseau transmet la date de mise en service "2023-03-27" pour le dossier de raccordement du le projet lauréat ayant pour référence "OUE-RP-2022-000033"
