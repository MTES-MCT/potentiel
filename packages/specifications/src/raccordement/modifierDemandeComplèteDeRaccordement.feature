...
Fonctionnalité: Modifier une demande complète de raccordement
    ...
    # SCENARIO-02
    # @selection
    # Scénario: Un porteur de projet modifie une demande complète de raccordement avec une référence différente du dossier de raccordement
    #     Etant donné un dossier de raccordement
    #     Quand le porteur modifie une demande complète de raccordement avec une référence du dossier de raccordement différente
