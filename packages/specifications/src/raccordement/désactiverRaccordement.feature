...
Fonctionnalité: Supprimer le raccordement d'un projet
    ...
    Scénario: Le raccordement d'un projet est désactivé en cas d'abandon accordé
        ...
        Alors le raccordement du projet devrait être désactivé
        Et le dossier ne devrait plus être consultable dans la liste des dossiers du raccordement
