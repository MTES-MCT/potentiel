...
Fonctionnalité: Importer une candidature
    ...
    Scénario: Impossible d'importer 2 fois la même candidature
        ...
        Quand le DGEC validateur importe la candidature "Du boulodrome de Marseille" avec :
            ...
            | famille        |                 |
            | numéro CRE     | abc             |
        Alors l'utilisateur dgec devrait être informé que "Il est impossible d'importer 2 fois la même candidature"
    ...
    Scénario: Impossible d'importer une candidature d'une période d'AO "legacy"
        Quand le DGEC validateur importe la candidature "Du boulodrome de Marseille" avec :
            ...
            | période        | 1                           |
            | famille        |                             |
        Alors l'utilisateur dgec devrait être informé que "Cette période est obsolète et ne peut être importée"
    ...
    Scénario: Impossible d'importer une candidature sans la nature de l'exploitation si l'appel d'offres la requiert
        ...
        Alors l'utilisateur dgec devrait être informé que "Le champ nature de l'exploitation est requis pour cet appel d'offres"
    ...
    Scénario: Impossible d'importer une candidature sans installateur pour un appel d'offres qui a ce champ requis
        Quand le DGEC validateur importe la candidature "Du boulodrome de Marseille" avec :
            | appel d'offres | PPE2 - Petit PV Bâtiment |
            | installateur   |                          |
        Alors l'utilisateur dgec devrait être informé que "Le champ installateur est requis pour cet appel d'offres"
