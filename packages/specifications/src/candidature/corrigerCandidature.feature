...
Fonctionnalité: Corriger une candidature
    ...
    Scénario: Impossible de régénérer l'attestation d'une candidature non notifiée
        Quand le DGEC validateur corrige la candidature avec :
            | nom candidat               | abcd |
            | doit régénérer attestation | oui  |
        Alors la dgec devrait être informé que "L'attestation d'une candidature non notifiée ne peut pas être régénérée"
    ...
    Scénario: Impossible de changer le numéro CRE d'une candidature
        Quand le DGEC validateur corrige la candidature avec :
            | numéro CRE | x |
        Alors la dgec devrait être informé que "La candidature n'existe pas"
    ...
    Scénario: Impossible de changer le statut d'une candidature lauréate notifiée en éliminée
        ...
        Quand le DGEC validateur corrige la candidature avec :
            | statut | éliminé |
        Alors la dgec devrait être informé que "Le statut d'une candidature ne peut être modifié après la notification"
    ...
    Scénario: Corriger l'autorisation d'une candidature pour un appel d'offres qui a ce champ
        Etant donné la candidature lauréate "Du boulodrome de Marseille" avec :
            | appel d'offres                     | PPE2 - Petit PV Bâtiment |
            | numéro de l'autorisation           | ancien numéro            |
            | date d'obtention de l'autorisation | 01/01/2025               |
        Quand le DGEC validateur corrige la candidature avec :
            | numéro de l'autorisation           | nouveau numéro |
            | date d'obtention de l'autorisation | 01/07/2025     |
        Alors la candidature devrait être consultable
