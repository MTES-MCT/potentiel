...
import { TransmettreDemandeComplèteRaccordementPage } from './TransmettreDemandeComplèteRaccordementPage';
...
const meta = {
  ...
  tags: ['autodocs'],
  argTypes: {},
} satisfies Meta<typeof TransmettreDemandeComplèteRaccordementPage>;
