...
import {
  modifierDateMiseEnServiceAction,
  ModifierDateMiseEnServiceStateFormKeys,
} from './modifierDateMiseEnService.action';

export type ModifierDateMiseEnServiceFormProps = {
  projet: {
...
export const ModifierDateMiseEnServiceForm: FC<ModifierDateMiseEnServiceFormProps> = ({
  projet: { identifiantProjet, dateDésignation },
  dossierRaccordement: { référence, miseEnService },
}) => {
  const [validationErrors, setValidationErrors] = useState<
    ValidationErrors<ModifierDateMiseEnServiceStateFormKeys>
  >({});
