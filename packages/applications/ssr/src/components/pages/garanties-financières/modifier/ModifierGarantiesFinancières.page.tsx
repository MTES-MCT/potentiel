...
// export type ModifierGarantiesFinancièresProps = {
...
//       dateÉchéance?: string;
//       dateConsitution: string;
//       attestationConstitution?: { format: string };
//     };
//   };
// };

// export const ModifierGarantiesFinancièresPage: FC<ModifierGarantiesFinancièresProps> = ({
//   projet,
// }) => {
