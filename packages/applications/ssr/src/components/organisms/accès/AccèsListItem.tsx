...
export type PorteurListItemProps = RetirerAccèsProjetButtonProps;
...
type RetirerAccèsProjetButtonProps = {
  identifiantProjet: IdentifiantProjet.RawType;
  identifiantUtilisateur: Email.RawType;
  peutRetirerAccès: boolean;
  statutProjet: 'classé' | 'éliminé';
};
const RetirerAccèsProjetButton: FC<RetirerAccèsProjetButtonProps> = ({
  identifiantProjet,
  identifiantUtilisateur,
  peutRetirerAccès,
  statutProjet,
        ...
        form={{
          ...
          children: (
            <>
              ...
              <input type="hidden" value={statutProjet} name="statutProjet" />
              <input
                type="hidden"
