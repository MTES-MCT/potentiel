...
export default async function Page({
  ...
  return PageWithErrorHandling(async () =>
    withUtilisateur(async (utilisateur) => {
      ...
      if (
        !vérifierAppelOffreSoumisAuxGarantiesFinancières(candidature.appelOffre)
      ) {
...
const mapToProps: MapToProps = ({
  ...
  return {
    ...
    actuelles: garantiesFinancières.actuelles
      ? {
          type: getGarantiesFinancièresTypeLabel(
            garantiesFinancières.actuelles.type.type
          ),
          dateÉchéance:
    ...
    action:
      utilisateur.role.estÉgaleÀ(Role.porteur) && !dépôtEnCours
        ? "soumettre"
        : undefined,
  };
};
