    ...
    <Alert
      ...
      description={
        <p className="p-3">
          ...
          veuillez vérifier avec le cocontractant que tous les éléments attendus sur Potentiel sont
          corrects. Une fois l'achèvement déclaré sur Potentiel, vous ne pourrez plus effectuer de
          demandes ni de déclarations sur la plateforme. Vous aurez cependant toujours la
          possibilité de modifier les rubriques :{' '}
