    ...
    rightColumn={{
      children: (
        <>
          ...
          <Notice
            severity="warning"
            title="Avant de transmettre votre attestation de conformité"
            className="mb-4"
            description={
              <span>
                <br />
                ...
                sont corrects.
                <br />
                Une fois l'achèvement déclaré sur Potentiel, vous ne pourrez plus effectuer de
                demandes ni de déclarations sur la plateforme.
                <br />
