...
import { mapToInstallationAvecDispositifDeStockageProps } from '@/utils/historique/mapToProps/dispositif-de-stockage/mapToInstallationAvecDispositifDeStockageTimelineItemProps';
