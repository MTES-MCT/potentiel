...
export const metadata: Metadata = { title: 'Modifier le producteur' };
      ...
      return (
        <ModifierProducteurPage
          ...
          numéroImmatriculation={
            producteurActuel.numéroImmatriculation
              ? mapToPlainObject(producteurActuel.numéroImmatriculation)
              : undefined
          }
