          ...
          <div className="flex flex-col gap-8">
            <FieldGroup name="Informations générales">
              ...
              <Field name="Performances">
                <span>Puissance installée : {dépôt.puissance} MW</span>
            ...
            <FieldGroup name="Contact">
              ...
              <Field name="Numéro d'immatriculation">
                <span>Numéro SIRET : {dépôt.numéroImmatriculation?.siret || 'Non renseigné'}</span>
                <span>Numéro SIREN : {dépôt.numéroImmatriculation?.siren || 'Non renseigné'}</span>
              </Field>
