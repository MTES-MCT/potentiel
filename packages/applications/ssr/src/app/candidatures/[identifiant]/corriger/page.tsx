...
const mapToProps: MapToProps = (candidature, lauréat, cahierDesCharges) => ({
  candidature: {
    ...
    numéroDAutorisation: candidature.dépôt.autorisation?.numéro
      ? candidature.dépôt.autorisation.numéro
      : undefined,
    dateDAutorisation: candidature.dépôt.autorisation?.date
      ? candidature.dépôt.autorisation.date.formatter()
      : undefined,
    installateur: candidature.dépôt.installateur,
    coordonnées: candidature.dépôt.coordonnées?.formatterDecimal(),
    siret: candidature.dépôt.numéroIdentification
      ? candidature.dépôt.numéroIdentification.formatter().siret
      : undefined,
  },
