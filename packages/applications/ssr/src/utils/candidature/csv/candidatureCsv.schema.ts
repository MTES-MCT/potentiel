...
const colonnes = {
  ...
  puissanceInitiale: 'puissance_initiale',
...
const candidatureCsvRowSchema = z
  .object({
    ...
    [colonnes.puissanceProductionAnnuelle]: puissanceOuPuissanceDeSiteSchema,
    ...
    [colonnes.puissanceInitiale]: optionalPuissanceOuPuissanceDeSiteSchema,
