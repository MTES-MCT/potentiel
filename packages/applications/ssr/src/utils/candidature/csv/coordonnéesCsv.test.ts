...
describe('mapCsvRowToCoordonnées', () => {
  ...
  test('Coordonnées valides, formattées en français', () => {
    const actual = mapCsvRowToCoordonnées({
      'Coordonnées géodésiques WGS84 du barycentre de l’Installation : Latitude (degrés)': '46',
      'Coordonnées géodésiques WGS84 du barycentre de l’Installation : Latitude (minutes)': '50',
      'Coordonnées géodésiques WGS84 du barycentre de l’Installation : Latitude (secondes)':
        '49,88',
      'Coordonnées géodésiques WGS84 du barycentre de l’Installation : Latitude (cardinal)': 'N',
      'Coordonnées géodésiques WGS84du barycentre de l’Installation : Longitude (degrés)': '0',
      'Coordonnées géodésiques WGS84du barycentre de l’Installation : Longitude (minutes)': '16',
      'Coordonnées géodésiques WGS84du barycentre de l’Installation : Longitude (secondes)':
        '40,38',
      'Coordonnées géodésiques WGS84du barycentre de l’Installation : Longitude (cardinal)': 'O',
    });
    expect(actual).to.deep.equal({ latitude: 46.847189, longitude: -0.277883 });
  });
