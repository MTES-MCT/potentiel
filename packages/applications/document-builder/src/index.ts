export type { DonnéesDocument } from './abandon/accordAbandonAvecRecandidature/buildDocument.js';
export { buildDocument } from './abandon/accordAbandonAvecRecandidature/buildDocument.js';
