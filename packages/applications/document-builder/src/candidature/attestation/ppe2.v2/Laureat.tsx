...
export const Lauréat = ({ project }: LaureatProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        {période.title} période de l’appel d’offres visé en objet.
      </Text>
          ...
          <>
            ...
            {soumisAuxGarantiesFinancieres &&
              appelOffre.renvoiRetraitDesignationGarantieFinancieres && (
                ...
                >
                  - prévoir une durée de garantie financière d’exécution couvrant le projet jusqu’à
                  6 mois après la date d’Achèvement de l’installation (date de fourniture de
