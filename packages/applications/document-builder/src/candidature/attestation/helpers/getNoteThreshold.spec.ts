...
//   describe(`when the période has a note threshold`, () => {
//     const fakeProject = {
//       période: {
//         noteThreshold: 99,
//       },
...
//   describe(`when the période has a note threshold by category`, () => {
//     const fakeProject = {
//       période: {
...
//   describe(`when the période does not have a note threshold by category`, () => {
//     describe(`when the période does not have a note threshold by family`, () => {
//       const fakeProject = {
//         puissance: 10,
//         appelOffre: {
//           période: {},
...
//   describe(`when the période has a note threshold by family`, () => {
...
//       describe(`when the project family exists in the période`, () => {
...
//       describe(`when the project family does not exist in the période`, () => {
