...
import { transmettreDateAchevementParLotHandler } from './transmettreDateAchevementParLot.handler.js';
...
export const achevementHandlers: AchevementV1 = {
  ...
  transmettreDateDAchevementParLot: transmettreDateAchevementParLotHandler,
};
