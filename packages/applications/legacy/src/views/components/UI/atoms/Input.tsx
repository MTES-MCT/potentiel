  ...
  return (
    <>
      <input
        ...
        } outline-offset-4 outline-2 outline-solid outline-outline-base rounded-none disabled:text-grey-625-base disabled:cursor-not-allowed disabled:border-b-grey-925-base disabled:bg-grey-950-base read-only:cursor-not-allowed read-only:border-b-grey-925-base read-only:bg-grey-950-base read-only:text-grey-625-base ${className}`}
        onChange={(e) => {
          valueChanged(true);
          onChange && onChange(e);
        }}
