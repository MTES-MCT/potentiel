...
import { registerDemandeModificationActionnaireQuery } from './consulterDemande/consulterDemandeModificationActionnaire.query';
...
export const registerActionnaireQueries = (dependencies: ActionnaireQueryDependencies) => {
  ...
  registerDemandeModificationActionnaireQuery(dependencies);
};
