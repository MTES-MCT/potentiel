...
import type { EnregistrerChangementNomProjetCommand } from './enregistrerChangementNomProjet.command.js';
...
export const registerEnregistrerChangementNomProjetUseCase = () => {
  const runner: MessageHandler<EnregistrerChangementNomProjetUseCase> = async ({
    ...
    const pièceJustificative = DocumentNomProjet.pièceJustificative({
      identifiantProjet: identifiantProjetValue,
      enregistréLe: enregistréLeValue,
