...
const withProjectId = (url: string) => (projectId: string) => withParams(url)({ projectId });
...
class routes {
  ...
  static PROJECT_DETAILS = (projectId?: string) => {
  ...
  static CHOISIR_CAHIER_DES_CHARGES = (projetId?: string) => {
  ...
  static PREVIEW_CANDIDATE_CERTIFICATE = (project?: {
    ...
    if (project) {
      return route.replace(':projectId', project.id).replace(':document', `aperçu-attestation.pdf`);
    } else return route;
  };
  ...
  static CANDIDATE_CERTIFICATE_FOR_ADMINS = (project: { id: string; certificateFileId: string }) =>
    routes.DOWNLOAD_CERTIFICATE_FILE(project.id, project.certificateFileId, `attestation.pdf`);
  ...
  static ADMIN_SIGNALER_DEMANDE_DELAI_PAGE = (projectId?: string) => {
  ...
  static ADMIN_SIGNALER_DEMANDE_ABANDON_GET = (projectId?: string) => {
  ...
  static ADMIN_SIGNALER_DEMANDE_RECOURS_GET = (projectId?: string) => {
  ...
  static DEMANDER_DELAI = (projectId?: string) => {
  ...
  static CHANGER_FOURNISSEUR = (projectId?: string) => {
  ...
  static GET_LISTE_DOSSIERS_RACCORDEMENT = (identifiantProjet?: string) => {
  ...
  static POST_TRANSMETTRE_DEMANDE_COMPLETE_RACCORDEMENT = (identifiantProjet?: string) => {
  ...
  static GET_TRANSMETTRE_DEMANDE_COMPLETE_RACCORDEMENT_PAGE = (identifiantProjet?: string) => {
  ...
  static GET_MODIFIER_GESTIONNAIRE_RESEAU_PROJET_PAGE = (identifiantProjet?: string) => {
    return `/projet/${
      identifiantProjet ? encodeURIComponent(identifiantProjet) : ':identifiantProjet'
    }/raccordements/modifier-gestionnaire-reseau.html`;
  };

  static POST_MODIFIER_GESTIONNAIRE_RESEAU_PROJET = (identifiantProjet?: string) => {
    return `/projet/${
      identifiantProjet ? encodeURIComponent(identifiantProjet) : ':identifiantProjet'
  ...
  static GET_PAGE_RACCORDEMENT_SANS_DOSSIER_PAGE = (identifiantProjet?: string) => {
    return `/projet/${
      identifiantProjet ? encodeURIComponent(identifiantProjet) : ':identifiantProjet'
