      ...
      <div class="p-2 lg:p-0 text-lg">
        <div class="flex flex-col xl:mx-auto xl:max-w-7xl">
          <section class="flex flex-row px-2 pb-1 lg:p-4 items-center">
            <a class="text-black flex items-center" href="${properties.potentielUrl}" style="background: none">
              ...
              <div class="ml-2 lg:ml-8 no-underline">
              ...
              <ul
                ...
                <li>
                  <a
                    ...
                    style="color: #000091; background: none"
                    target="_blank"
                    rel="noopener"
                    href="https://docs.potentiel.beta.gouv.fr/info/guide-dutilisation-potentiel"
                  >
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="lg:hidden text-blue-france-sun-base" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><g><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm-1-5h2v2h-2v-2zm2-1.645V14h-2v-1.5a1 1 0 0 1 1-1 1.5 1.5 0 1 0-1.471-1.794l-1.962-.393A3.501 3.501 0 1 1 13 13.355z"></path></g></svg>
                    <span class="hidden lg:flex lg:items-center mx-1 text-blue-france-sun-base"><span class="pt-0.5">Aide</span>
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="w-4 h-4 ml-1" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><title>(ouvrir dans un nouvel onglet)</title><g><path fill="none" d="M0 0h24v24H0z"></path><path d="M10 6v2H5v11h11v-5h2v6a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h6zm11-3v8h-2V6.413l-7.793 7.794-1.414-1.414L17.585 5H13V3h8z"></path></g></svg></span>
                  </a>
                </li>
              </ul>
            </div>
